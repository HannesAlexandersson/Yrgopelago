    ...
    <div class="booking-form-wrapper">
      <form action="/scripts/handle-booking.php" method="post" id="bookingForm" class="booking-form">
        ...
        <div class="features-checkbox">
          ...
          <input type="checkbox" id="bedtimeStoryteller" name="features[]" value="bedtime_storyteller">
          <label for="bedtimeStoryteller">Bedtime Storyteller</label>

          <input type="checkbox" id="undergroundHotsprings" name="features[]" value="underground_hotsprings">
          <label for="undergroundHotsprings">Underground Hotsprings</label>

          <input type="checkbox" id="massageTherapy" name="features[]" value="massage_therapy">
