<div class="bg-pre">
  ...
  <div class="right-side-pre">

    <section class="img-grid-wrapper">

      <div class="img-grid-top">
        <img src="../../assets/images/hotel/topLeft.svg" alt="beach-hotel at night" class="img-grid-item">
        <img src="../../assets/images/hotel/topMid.svg" alt="beach-hotel at night" class="img-grid-item">
        <img src="../../assets/images/hotel/topRight.svg" alt="beach-hotel at night" class="img-grid-item">
      </div>
      <div class="img-grid-bottom">
        <img src="../../assets/images/hotel/botLeft.svg" alt="beach with palms at night, sunset" class="img-grid-item">
        <img src="../../assets/images/hotel/botRight.svg" alt="beach with palms at late sunset" class="img-grid-item">
      </div>
